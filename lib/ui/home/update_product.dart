...
class UpdateProductScreen extends StatelessWidget {
  String imageUrl;
  UpdateProductScreen(this.imageUrl);
  @override
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              CustomTextField(provider.productNameController, 'product name',
                  const EdgeInsets.symmetric(horizontal: 10, vertical: 5)),
              CustomTextField(
                  provider.productDiscController,
                  'product Description',
                  const EdgeInsets.symmetric(horizontal: 10, vertical: 5)),
              CustomTextField(provider.productPriceController, 'product price',
                  const EdgeInsets.symmetric(horizontal: 10, vertical: 5)),
              Spacer(),
              CustomButton('ADD PRODUCT', provider.updateProduct)
            ],
          ),
        );
      }),
